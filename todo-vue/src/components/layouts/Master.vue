<template>
  <div id="app">
    <ul class="nav">
      ...
      <li v-if="loggedIn" @click="toggleSubModal()">
        <router-link to="">Settings</router-link>
        <ul v-if="submenu" class="sublinks">
          <li><router-link :to="{ name: 'unit' }">Units</router-link></li>
          <li><router-link :to="{ name: 'product' }">Products</router-link></li>
        </ul>
      </li>
      <li v-if="!loggedIn">
